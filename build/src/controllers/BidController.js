...
const YoutubeController_1 = __importDefault(require("./YoutubeController"));
class BidController {
    constructor(id, fileName) {
        ...
        this.startTimer = (index) => {
            ...
            this.timer = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                if (!this.youtube) {
                    console.log("this.youtube is !");
                    clearInterval(this.timer);
                    return;
                }
                const chatList = yield this.youtube.getChat();
...
BidController.init = (id, fileName, url) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!BidController.shared.youtube) {
        BidController.shared.youtube = yield YoutubeController_1.default.init();
    }
    if (BidController.shared.youtube.url !== url) {
        yield ((_b = BidController.shared.youtube) === null || _b === void 0 ? void 0 : _b.goto(url));
    }
